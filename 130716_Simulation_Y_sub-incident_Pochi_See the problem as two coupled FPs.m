...
cd('D:\Users\TuanShu\');
dlmwrite('Position_micron.txt',Position_micron(abs(Position_micron-(l_sam-l_ref+760))<50)-((l_sam-l_ref+760)),'delimiter','\t','newline','pc', 'precision', 24);
dlmwrite('real_FFT_S.txt',(real(FFT_S(abs(Position_micron-(l_sam-l_ref+760))<50))/max(real(FFT_S(abs(Position_micron-(l_sam-l_ref+760))<50))))','delimiter','\t','newline','pc', 'precision', 24);
