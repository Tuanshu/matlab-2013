...
N_Shift=[-9]';     %Physically must be integer, 若不是integer那會算錯
...
Ratio_Upper2Reference=0.825; %if the front interface has larger interference eff than referential glass, Ratio_Upper2Reference>1
Thickness=[2.75]'*1E-6;      %Initial Value
n_should=1.6;
