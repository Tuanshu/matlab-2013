...
Thickness=(2.55).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
n_should=1.6;
Ratio_Lower2Upper=1.1;%+[-0.05:0.005:0.05];%+[-0.2:0.02:0.2];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
...
Wavelength_Considered_Min=520;          %nm
...
dlmwrite('Wavelength_micron_Considered_3micron.txt',Wavelength_micron_Considered,'delimiter','\t','newline','pc');
dlmwrite('n_3micron.txt',real(n_Best),'delimiter','\t','newline','pc');
dlmwrite('k_3micron.txt',imag(n_Best),'delimiter','\t','newline','pc');
dlmwrite('T_3micron.txt',T_Best,'delimiter','\t','newline','pc');
dlmwrite('T_exp_3micron.txt',T_Considered,'delimiter','\t','newline','pc');