...
cd('D:\Users\TuanShu\130822\');

Data=importdata('130822_LYSO_inter_sam is gblue_rev3_0.5s_pump 30mW.txt');

Ref=importdata('130822_LYSO_ref_sam is gblue_rev3_0.5s_pump 30mW.txt');

Sam=importdata('130822_LYSO_sam_sam is gblue_rev3_0.5s_pump 30mW.txt');
Data(:,2)=Data(:,2)-Ref(:,2)-Sam(:,2);
...
Max_Wavelength=530;             %nm
Min_Wavelength=365;             %nm
N_f=8192;
N_t=8192*8;
