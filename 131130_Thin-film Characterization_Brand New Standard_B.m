...
Sample_Path='D:\Users\TuanShu\131130\Blue CF';
Reference_Path='D:\Users\TuanShu\131130\Glass';
Spectroscopy_Path='D:\Users\TuanShu\131130\blue.jws.txt';
cd('D:\Users\TuanShu\');
...
Thickness=[8.2/16]'*1E-6;      %Initial Value
if load_nk ==1
...
%%%
Wavelength_Center=430;

Center_Wavelength_micron=0.43;
Wavelength_Considered_Min=400; %510         %nm
Wavelength_Considered_Max=480;  %580

Max_Wavelength=520;             %nm
Min_Wavelength=370;             %nm
N_f=8192;
N_t=N_f*16;
...
%dlmwrite('Signal_Sample_1.txt',real(Signal_Sample_1)/max(abs(Signal_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Signal_Sample_2.txt',real(Signal_Sample_2)/max(abs(Signal_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Signal_Sample_1_abs.txt',abs(Signal_Sample_1)/max(abs(Signal_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Signal_Sample_2_abs.txt',abs(Signal_Sample_2)/max(abs(Signal_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Signal_Sample_abs.txt',(abs(Signal_Sample_1)+abs(Signal_Sample_2))/max(abs(Signal_Sample_2)),'delimiter','\t','newline','pc');

%dlmwrite('Wavelength_micron.txt',Wavelength_micron,'delimiter','\t','newline','pc');
%dlmwrite('Spectrum_Sample_1_abs.txt',abs(Spectrum_Sample_1)/max(abs(Spectrum_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Spectrum_Sample_2_abs.txt',abs(Spectrum_Sample_2)/max(abs(Spectrum_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Spectrum_Sample_1.txt',real(Spectrum_Sample_1)/max(abs(Spectrum_Sample_2)),'delimiter','\t','newline','pc');
%dlmwrite('Spectrum_Sample_2.txt',real(Spectrum_Sample_2)/max(abs(Spectrum_Sample_2)),'delimiter','\t','newline','pc');
...
[max_Signal_Sample_1 maxindex_Signal_Sample_1]=max(abs(Signal_Sample_1));
dlmwrite('Aexp.txt',Aexp/max(Bexp),'delimiter','\t','newline','pc');
dlmwrite('Bexp.txt',Bexp/max(Bexp),'delimiter','\t','newline','pc');
dlmwrite('Wavelength_micron_Considered.txt',Wavelength_micron_Considered,'delimiter','\t','newline','pc');
dlmwrite('Cunwrap.txt',Cunwrap,'delimiter','\t','newline','pc');
