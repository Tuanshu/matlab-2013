...
%% Parameters
Ratio_Upper2Reference=1.45;%+[-0.05:0.005:0.05];
...
xlabel('Wavelength (micron)');
ylabel('T');
dlmwrite('n.txt',mean(real(n_Best),2),'delimiter','\t','newline','pc');

dlmwrite('k.txt',mean(imag(n_Best),2),'delimiter','\t','newline','pc');

dlmwrite('T.txt',mean(T_Best,2),'delimiter','\t','newline','pc');
