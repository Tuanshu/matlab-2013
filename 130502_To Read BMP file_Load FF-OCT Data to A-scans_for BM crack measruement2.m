...
Sample_Path='D:\Users\TuanShu\130725_Cellgap2\';
Sample_Path_Bscan='D:\Users\TuanShu\130725_Cellgap2\Enface\';
...
Image_Temp_2(1:(ROI(1,2)-ROI(1,1)+1)/Binning_Factor,1:(ROI(2,2)-ROI(2,1)+1)/Binning_Factor)=0;
    ...
    plot(real(Image_Stack(:,300,300)));
    clear DC_volume
    [Max_value Max_index]=max(Image_Stack(:,300,300));
    Image_Stack=circshift(Image_Stack,set_peak_index-Max_index);

    FFT_Stack=fft(Image_Stack,[],1);
    plot(real(FFT_Stack(:,300,300)));
