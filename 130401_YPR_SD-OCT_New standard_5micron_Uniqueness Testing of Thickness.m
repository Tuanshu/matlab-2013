...
if index_calculation==1   
    ...
    for p=1:length(Thickness)
        ...
        Merit_A_Record(p)=sum((Aexp-A(n,Thickness_Now,Ratio_Lower2Upper_Now,Ratio_Upper2Reference_Now)).^2)^0.5;
        Merit_B_Record(p)=sum((Bexp-B(n,Thickness_Now,Ratio_Lower2Upper_Now,Ratio_Upper2Reference_Now)).^2)^0.5;
        Merit_C_Record(p)=sum((C_Temp-C(n,Thickness_Now,Ratio_Lower2Upper_Now,Ratio_Upper2Reference_Now)).^2)^0.5;
