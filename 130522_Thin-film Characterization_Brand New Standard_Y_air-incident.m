...
N_Shift=[-10]';     %Physically must be integer, 若不是integer那會算錯
...
Ratio_Upper2Reference=0.835; %if the front interface has larger interference eff than referential glass, Ratio_Upper2Reference>1
...
Wavelength_Considered_Min=539.5; %510         %nm
Wavelength_Considered_Max=540.5;  %580
