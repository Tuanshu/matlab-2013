...
cd('D:\Users\TuanShu\130531\YPR 11\');
%% Data Loading
...
%% Conv
Signal_Bscan_Envelope_Shifted_Extend=Signal_Bscan_Envelope_Shifted;
Extend_Range=(size(Signal_Bscan_Envelope,2)-Pixel_Average_Lateral+2):(size(Signal_Bscan_Envelope,2)+Pixel_Average_Lateral-1);
for pp=1:size(Signal_Bscan_Envelope,1)
    Signal_Bscan_Envelope_Shifted_Extend(pp,Extend_Range)=interp1((size(Signal_Bscan_Envelope,2)-Pixel_Average_Lateral+2):size(Signal_Bscan_Envelope,2),Signal_Bscan_Envelope_Shifted(pp,(size(Signal_Bscan_Envelope,2)-Pixel_Average_Lateral+2):size(Signal_Bscan_Envelope,2)),(size(Signal_Bscan_Envelope,2)-Pixel_Average_Lateral+2):((Pixel_Average_Lateral-2)/(2*(Pixel_Average_Lateral-2)+1)):size(Signal_Bscan_Envelope,2));
    Signal_Bscan_Envelope_Shifted(pp,:)=conv(Signal_Bscan_Envelope_Shifted_Extend(pp,:),ones(Pixel_Average_Lateral,1)/Pixel_Average_Lateral,'valid');
end
