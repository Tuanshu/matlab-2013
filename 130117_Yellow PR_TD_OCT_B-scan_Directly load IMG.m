...
Sample_Path='D:\Users\TuanShu\130117\';
Reference_Path='D:\Users\TuanShu\130117\';
Spectroscopy_Path='D:\Users\TuanShu\';


%% Parameters
Ratio_Upper2Reference=1.2;%+[-0.05:0.005:0.05];
Thickness=(4.4).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
n_should=1.65;
Ratio_Lower2Upper=1.2;%+[-0.05:0.005:0.05];%+[-0.2:0.02:0.2];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
...
cd('D:\Users\TuanShu\130116\130116_Yellow\');
set_peak_index=1500;
Averaging_Factor=10;
Sampling_Rate=1035.197/10;
PZT_Speed=0.895972828129950;         %micron/sec
...
legend('Y index = 10','Y index = 20','Y index = 30','Y index = 40','Y index = 50','Y index = 60','Y index = 70','Y index = 80');
