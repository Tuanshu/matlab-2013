...
N_Shift=[-5]';     %Physically must be integer, 若不是integer那會算錯
...
Ratio_Upper2Reference=0.5; %if the front interface has larger interference eff than referential glass, Ratio_Upper2Reference>1
Thickness=[4.75]'*1E-6;      %Initial Value
n_should=1.6;
Ratio_Lower2Upper=2.5;     %if the rear interface has larger interference eff than front interface, Ratio_Lower2Upper>1
