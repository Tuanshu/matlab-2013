...
Data=importdata('supercontinuum.txt');
...
plot(Position_micron-Position_micron(maxindex),abs(fftshift(Signal)),Position_micron-Position_micron(maxindex),real(fftshift(Signal)));
