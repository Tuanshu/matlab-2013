...
% Parameters
Ratio_Upper2Reference=1.75451;%+[-0.05:0.005:0.05];
Thickness=(4.7).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
n_should=1.55;
Ratio_Lower2Upper=0.825;%+[-0.05:0.005:0.05];%+[-0.2:0.02:0.2];  %([-1:0.02:1]+10.82)*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
...
subplot(3,1,1)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.02),real(n_Best(abs(Wavelength_micron_Considered-0.54)<0.02)),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.02),SDOCT_n(abs(SDOCT_Wavelength_micron-0.54)<0.02));
xlabel('Wavelength (micron)');
ylabel('n');

subplot(3,1,2)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.02),imag(n_Best(abs(Wavelength_micron_Considered-0.54)<0.02)),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.02),SDOCT_k(abs(SDOCT_Wavelength_micron-0.54)<0.02));
xlabel('Wavelength (micron)');
ylabel('k');

subplot(3,1,3)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.02),T_Best(abs(Wavelength_micron_Considered-0.54)<0.02),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.02),SDOCT_T(abs(SDOCT_Wavelength_micron-0.54)<0.02));
xlabel('Wavelength (micron)');
ylabel('T');
