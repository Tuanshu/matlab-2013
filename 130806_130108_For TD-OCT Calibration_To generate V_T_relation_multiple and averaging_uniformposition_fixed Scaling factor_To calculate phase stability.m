...
Position_Voltage_Relation=[Voltage_UniformBase' mean(Position_UniformBase,2)];


dlmwrite('Position_Voltage_Relation.txt',Position_Voltage_Relation,'delimiter','\t','newline','pc','precision', '%.6f');
