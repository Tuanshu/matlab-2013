...
cd('D:\Users\TuanShu\130531\GPR 1\');
%% Data Loading
...
Signal_Bscan_Envelope_Shifted_Extend(:,(size(Signal_Bscan_Envelope,2)+1):(size(Signal_Bscan_Envelope,2)+Pixel_Average_Lateral-1))=Signal_Bscan_Envelope_Shifted(:,1:(Pixel_Average_Lateral-1));
