...
M=590;  %which line for calibration
N=1275; %which pixel is center
...
Thickness_1=26.4347*1E-6;
Thickness_2=36.4961*1E-6;

Data1_2D=importdata('131010_POS1');
%OPD4=47.769897

Data1_2D=rot90(Data1_2D);

Data2_2D=importdata('131010_POS2');
%OPD1=61.605919
...
plot(smooth(Calibration_array,100));

dlmwrite('Calibration_array.txt',smooth(Calibration_array,100),'delimiter','\t','newline','pc');
