...
cd('D:\Users\TuanShu\130531\YPR 4\');
%% Data Loading
...
for pp=1:size(Signal_Bscan_Envelope,1)
    Signal_Bscan_Envelope_Shifted_Conv(pp,:)=conv(Signal_Bscan_Envelope_Shifted(pp,:),ones(Pixel_Average_Lateral,1)/Pixel_Average_Lateral,'same');
end
