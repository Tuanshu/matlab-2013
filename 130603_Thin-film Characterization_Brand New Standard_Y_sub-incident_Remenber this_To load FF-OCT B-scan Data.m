...
Thickness=[4.2:0.02:4.6]'*1E-6;      %Initial Value
if load_nk ==1
...
Least_Separation=4;
Window_Size_Right_1=2;  %use for the left side of 1st interface and right side of second interface
Window_Size_Left_1=2;  %use for the left side of 1st interface and right side of second interface
...
Wavelength_Considered_Max=541;  %580
