...
Data=dlmread(sprintf('130103_f%g_V%d.txt',Frequency,Range));                   %Asuume: line 1: time, line 2: interference signal, line 3: voltage 121219_f0.001_V2to8.txt怪怪
...
while Voltage_previous_max_index<size(Signal_all,1)-2*(Voltage_next_max_index-Voltage_min_index)
    ...
    %以下關於Position和Voltage的計算跟實際上用的無關, 只是用來生圖的
    Position_UniformBase(:,p)=interp1(Voltage,Position,Voltage_UniformBase);
