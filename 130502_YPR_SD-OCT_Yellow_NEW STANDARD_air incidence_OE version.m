...
N_Shift=[0]';     %Physically must be integer, 若不是integer那會算錯
...
Sample_Path='D:\Users\TuanShu\130502\air-1\sample\';
Reference_Path='D:\Users\TuanShu\130502\air-1\glass\';
...
Ratio_Upper2Reference=[0.5:0.1:1.5];
Thickness=[4.75]'*1E-6;      %Initial Value
n_should=1.6;
Ratio_Lower2Upper=[0.5:0.1:1.5];

%%%
DC_cutoff=20;   %works for all lateral position
Least_Separation=3;
Window_Size=3;  %use for the left side of 1st interface and right side of second interface
