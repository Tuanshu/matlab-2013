...
C = @ (n,Thickness_Now,Ratio_Lower2Upper_Now,Ratio_Upper2Reference_Now) angle(1./r1(n).*(Ratio_Lower2Upper_Now.*(t1(n).*t1_r(n).*r2(n))))+(4*pi.*Frequency_Considered.*real(n).*Thickness_Now/c)+2*pi*N_Shift;
