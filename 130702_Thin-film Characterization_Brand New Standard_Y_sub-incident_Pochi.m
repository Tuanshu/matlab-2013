...
plot(Position_micron,Signal_Reference);
...
plot(Frequency,abs(Spectrum_Sample_1),Frequency,real(Spectrum_Sample_1));%,Wavelength_micron(Wavelength_micron<1),abs(Spectrum_Reference(Wavelength_micron<1)));
xlabel('Frequency (Hz)');
ylabel('Interference Power spectral density (a.u.)');
