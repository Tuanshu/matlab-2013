...
subplot(6,1,4)
plot(1:(length(dn_real_record)-1),dn_real_record(2:end));
xlabel('Number');
ylabel('dn_real_record');

subplot(6,1,5)
plot(1:(length(dn_imag_record)-1),dn_imag_record(2:end));
xlabel('Number');
ylabel('dn_imag_record');

subplot(6,1,6)
plot(1:(length(dthickness_record)-1),dthickness_record(2:end));
xlabel('Number');
