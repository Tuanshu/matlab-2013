...
subplot(3,1,1)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.03),real(n_Best(abs(Wavelength_micron_Considered-0.54)<0.03)),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.03),SDOCT_n(abs(SDOCT_Wavelength_micron-0.54)<0.03));
xlabel('Wavelength (micron)');
ylabel('n');

subplot(3,1,2)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.03),imag(n_Best(abs(Wavelength_micron_Considered-0.54)<0.03)),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.03),SDOCT_k(abs(SDOCT_Wavelength_micron-0.54)<0.03));
xlabel('Wavelength (micron)');
ylabel('k');

subplot(3,1,3)
plot(Wavelength_micron_Considered(abs(Wavelength_micron_Considered-0.54)<0.03),T_Best(abs(Wavelength_micron_Considered-0.54)<0.03),SDOCT_Wavelength_micron(abs(SDOCT_Wavelength_micron-0.54)<0.03),SDOCT_T(abs(SDOCT_Wavelength_micron-0.54)<0.03));
xlabel('Wavelength (micron)');
ylabel('T');
...
xlabel('Wavelength (micron)');
ylabel('T');
dlmwrite('FFOCT_n.txt',mean(real(n_Best),2),'delimiter','\t','newline','pc');

dlmwrite('FFOCT_k.txt',mean(imag(n_Best),2),'delimiter','\t','newline','pc');

dlmwrite('FFOCT_T.txt',mean(T_Best,2),'delimiter','\t','newline','pc');
dlmwrite('FFOCT_Wavelength_micron_Considered.txt',Wavelength_micron_Considered,'delimiter','\t','newline','pc');
