...
Ratio_Upper2Reference=1.4;
Thickness=4.68*1E-6;      %Initial Value
n_should=1.6;
Ratio_Lower2Upper=1.15;
...
subplot(1,4,1)
%plot(Position_micron(Position_micron<50),Signal_Sample_1(Position_micron<50),Position_micron(Position_micron<50),Signal_Sample_2(Position_micron<50),Position_micron(Position_micron<50),Signal_Reference(Position_micron<50));
plot(Position_micron(abs(Position_micron-30)<10),Signal_Sample_2(abs(Position_micron-30)<10),Position_micron(abs(Position_micron-30)<10),Signal_Reference(abs(Position_micron-30)<10));
xlabel('Optical Path Difference (micron)');
ylabel('Amplitude (a.u.)');

subplot(1,4,2)
plot(Wavelength_micron_Considered,Aexp);
xlabel('Wavelength (micron)');
ylabel('Normalized Inteference Spectrum');


subplot(1,4,3)
plot(Wavelength_micron_Considered,Bexp);
xlabel('Wavelength (micron)');
ylabel('Normalized Inteference Spectrum');
