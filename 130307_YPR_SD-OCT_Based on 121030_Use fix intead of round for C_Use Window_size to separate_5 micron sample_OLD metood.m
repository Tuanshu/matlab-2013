...
Thickness=(4.5).*1E-6;% ([-0.1:0.1:0.1]+2.55).*1E-6; In this file, it is the initial guess of thickness
n_should=1.6;
...
dlmwrite('Wavelength_micron_Considered_5micron.txt',Wavelength_micron_Considered,'delimiter','\t','newline','pc');
dlmwrite('n_5micron.txt',real(n_Best),'delimiter','\t','newline','pc');
dlmwrite('k_5micron.txt',imag(n_Best),'delimiter','\t','newline','pc');
dlmwrite('T_5micron.txt',T_Best,'delimiter','\t','newline','pc');
dlmwrite('T_exp_5micron.txt',T_Considered,'delimiter','\t','newline','pc');